...
/**
 * @brief Process class to apply the BSpline transformation given by the
 *        control points to the rest of the pixels in the region of interest.
 *        This results in pixelwise displacements.
 *
 */
class Deformation: public Process {
    public:
	...
	struct LaunchParameters: Process::LaunchParameters {
	    ...
	    LaunchParameters(const std::shared_ptr<Data>& BBallData):
		BBallData(BBallData) {}
	};
