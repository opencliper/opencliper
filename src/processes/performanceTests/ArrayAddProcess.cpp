...
void ArrayAddProcess::launch() {
	...
	BTTHROW(std::invalid_argument(std::string(CLASSNAME) + std::string("::launch: non-existing second array")), "ArrayAddProcess::launch");
    }
...
try {
	...
	std::cerr << "number of rows: " << height << "\tnumber of columns: " << width << std::endl;
